...
> {
    ...
    //The function of the include() and dynamicInclude() methods is to include relational data in Prisma Query.
    ...
    //The user can decide which relation to include through the URL.
     dynamicInclude(
